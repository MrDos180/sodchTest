...
import static ru.elements.Buttons.rrcVisibleButton;

public class Rrc_Duty_Officer {
    @Before
    public  void createUser () {

        createUserAction("ЦОР Дежурный офицер");
    ...
    public void deleteRole (){
        deleteRoleAction("ЦОР Дежурный офицер");
    }
}
